...
class PaseMedicoSecondPage extends StatefulWidget {
  final List<File> file;

  const PaseMedicoSecondPage({super.key, required this.file});

  @override
  State<PaseMedicoSecondPage> createState() => _PaseMedicoSecondPageState();
}

class _PaseMedicoSecondPageState extends State<PaseMedicoSecondPage> {
