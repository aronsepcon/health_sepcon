...
class CovidPreviewPage extends StatefulWidget{

  final VacunaModel covidModel;
  const CovidPreviewPage({super.key, required this.covidModel});

  @override
  State<CovidPreviewPage> createState() => _CovidPreviewPageState();
}

class _CovidPreviewPageState extends State<CovidPreviewPage>{
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                child: PdfContainer(
                  urlPdf: widget.covidModel.adjunto!,
                  isLocal: false,
                  titlePDF: titlePdf(),
                ),
              ),
  ...
  String titlePdf(){
    List<String> splitUrl = widget.covidModel.adjunto!.split("/");
